...
export default function SubmitRequestPage() {
  ...
  return (
    <>
      <div className="welcome-banner" style={{background:'linear-gradient(135deg,#1e3a5f 0%,#2563eb 100%)'}}>
      ...
      <div className="card">
        ...
        <div className="info-tip" style={{width:'100%',marginBottom:20}}>
          <span>💡</span> Your account must be <strong>ACTIVE</strong> (documents verified) to submit requests.
        </div>
        <form onSubmit={handleSubmit}>
          ...
          <div className="actions-row">
            ...
            <button type="button" className="btn btn-outline" onClick={()=>navigate('/my-requests')}>Cancel</button>
          </div>
        </form>
      </div>
    </>
