...
function HelpPage() {
  ...
  return (
    <>
      <div className="welcome-banner" style={{ background: 'linear-gradient(135deg, #0c4a6e 0%, #0284c7 50%, #06b6d4 100%)' }}>
        <h2>❓ Help Center & FAQ</h2>
        <p>Find answers to frequently asked questions about registration, documents, account status, and more.</p>
      </div>
