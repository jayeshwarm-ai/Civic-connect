...
function AdminDashboard() {
  ...
  return (
    <>
      {/* Welcome Banner */}
      <div className="welcome-banner" style={{ background: 'linear-gradient(135deg, #0f172a 0%, #1e293b 50%, #312e81 100%)' }}>
        <h2>📊 Admin Dashboard</h2>
        <p>Welcome back, {user?.name}. Manage citizens, verify documents, and oversee the CivicConnect platform.</p>
      </div>
