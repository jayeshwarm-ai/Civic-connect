  ...
  return (
    <>
      <div className="welcome-banner" style={{ background: 'linear-gradient(135deg, #0f172a 0%, #7c2d12 50%, #ea580c 100%)' }}>
        <h2>⭐ My Feedback</h2>
        <p>Rate your experience with resolved service requests and help us improve.</p>
      </div>

      <div className="stats-row">
        <div className="stat-card">
          <div className="stat-icon" style={{ background: '#fef3c7' }}>⭐</div>
          <div><div className="stat-value">{feedbacks.length}</div><div className="stat-label">Submitted</div></div>
        </div>
        <div className="stat-card">
          <div className="stat-icon" style={{ background: '#dbeafe' }}>📋</div>
          <div><div className="stat-value">{closedRequests.length}</div><div className="stat-label">Awaiting Feedback</div></div>
        </div>
        <div className="stat-card">
