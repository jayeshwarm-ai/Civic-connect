...
export default function ReportsDashboardPage() {
  ...
  return (
    <>
      <div className="welcome-banner" style={{ background: 'linear-gradient(135deg, #0f172a 0%, #312e81 50%, #7c3aed 100%)' }}>
        <h2>📊 Reports Dashboard</h2>
        <p>Generate and view aggregated reports across all CivicConnect services.</p>
      </div>
