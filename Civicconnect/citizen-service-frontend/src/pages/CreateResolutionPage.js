...
export default function CreateResolutionPage() {
  ...
  return (
    <>
      <div className="welcome-banner" style={{ background: 'linear-gradient(135deg, #312e81 0%, #4f46e5 100%)' }}>
        <h2>➕ Create Resolution</h2>
        <p>Start resolving an assigned service request by creating a resolution with action plan.</p>
      </div>
      <div className="card">
