...
export const createAuditRecord = (data) =>
  api.post('/api/v1/compliance/audits', data);

export const getAuditRecordById = (auditId) =>
  api.get(`/api/v1/compliance/audits/${auditId}`);

export const updateAuditRecord = (auditId, data) =>
  api.patch(`/api/v1/compliance/audits/${auditId}`, data);

export const getAuditsByOfficer = (officerId) =>
  api.get(`/api/v1/compliance/audits/officer/${officerId}`);

export const getAuditsByStatus = (status) =>
  api.get(`/api/v1/compliance/audits?status=${status}`);
