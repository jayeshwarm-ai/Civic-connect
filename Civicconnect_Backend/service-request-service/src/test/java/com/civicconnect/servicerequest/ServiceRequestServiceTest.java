...
import com.civicconnect.servicerequest.service.impl.ServiceRequestServiceImpl;
...
class ServiceRequestServiceTest {
    ...
    void setUp() {
        submittedRequest = ServiceRequest.builder()
                ...
                .state("Tamil Nadu").city("Chennai").address("Main St, Block 4")
        ...
        assignedRequest = ServiceRequest.builder()
                ...
                .state("Tamil Nadu").city("Chennai").address("East St")
    ...
    void shouldSubmitRequestSuccessfully() {
        ...
        request.setState("Tamil Nadu"); request.setCity("Chennai"); request.setAddress("Main St");
