              ...
              <tr key={r.requestId}>
                ...
                <td>
                  <div style={{display:'flex',gap:4}}>
                    ...
                    {r.status==='ASSIGNED' &&
                      <Link to="/resolutions/create" state={{ requestId: r.requestId }} className="btn btn-small btn-success">Resolve</Link>}
                    {(r.status==='ASSIGNED'||r.status==='IN_PROGRESS') &&
                      <Link to={`/service-requests/${r.requestId}/update`} className="btn btn-small btn-primary">Update</Link>}
                  </div>
                </td>
              </tr>
            ))}
