...
export default function CreateResolutionPage() {
  ...
  const [form, setForm] = useState({
    requestId: prefilledRequestId ? String(prefilledRequestId) : '',
    actions: '',
  });
  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="Define your resolution plan for an assigned service request."
      />
      <div className="card">
        <div className="card-title">New Resolution</div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <textarea
              ...
              rows={5}
              placeholder="Describe the resolution plan and actions to be taken..."
              required
            />
          </div>
